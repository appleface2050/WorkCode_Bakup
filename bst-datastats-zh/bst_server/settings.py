...
if host == "123.56.202.57" or host == "101.201.39.219":
    ENVIRONMENT = 'aliyun'
elif host == "101.201.42.93" and BASE_DIR == "/var/www/html/bst-datastats-zh":
    ENVIRONMENT = 'aliyun_test_datastats'
elif host == "101.201.111.117" and BASE_DIR == "/var/www/html/bst-datastats-zh":
    ENVIRONMENT = 'aliyun_datastats'
elif host == "101.201.111.117" and BASE_DIR == "/var/www/html/master/bst-datastats-zh":
    ENVIRONMENT = 'aliyun_datastats'
else:
    ENVIRONMENT = 'win_test'
...
#     URL_SERVER_HOST = "127.0.0.1:8000"
# elif ENVIRONMENT == 'aliyun_test':
#     URL_SERVER_HOST = "101.201.42.93"
...
if ENVIRONMENT == "win_test":
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            # # 'NAME': 'tmp_bs_datastats',  # Or path to database file if using sqlite3.
            ...
            # 'HOST': 'rdsk75k0anuj28956uzlo.mysql.rds.aliyuncs.com',       #mysql_test
            
            'NAME': 'bs_datastats',  # Or path to database file if using sqlite3.
            'USER': 'bluestackscn',  # Not used with sqlite3.
            'PASSWORD': 'Bluestacks2016',  # Not used with sqlite3.
            'HOST': 'rm-2ze808r9i16dakko3o.mysql.rds.aliyuncs.com',


            # 'NAME': 'test_bs_datastats',  # Or path to database file if using sqlite3.
            # 'USER': 'bluestackscntest',  # Not used with sqlite3.
            # 'PASSWORD': 'Bluestacks2016test',  # Not used with sqlite3.
...
if ENVIRONMENT == "aliyun_datastats":
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'bs_datastats',  # Or path to database file if using sqlite3.
            'USER': 'bluestackscn',  # Not used with sqlite3.
            'PASSWORD': 'Bluestacks2016',  # Not used with sqlite3.
            'HOST': 'rm-2ze808r9i16dakko3.mysql.rds.aliyuncs.com',
            # Set to empty string for localhost. Not used with sqlite3.
            'PORT': '3306',  # Set to empty string for default. Not used with sqlite3.
            'ATOMIC_REQUEST': True,
        }
...
if ENVIRONMENT == "aliyun_test_datastats":
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'test_bs_datastats',  # Or path to database file if using sqlite3.
