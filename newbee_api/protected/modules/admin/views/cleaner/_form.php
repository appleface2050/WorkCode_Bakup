<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'filter_surplus_life',array('class'=>'span5','maxlength'=>255)); ?>
	...
	<?php echo $form->textFieldRow($model,'timeset',array('class'=>'span5','maxlength'=>1000)); ?>
