...
class REST:
    ...
    AccountSid='aaf98f894dd24f24014dd6fa0ada0356'
    AccountToken='7d18400b80f7475caad39bce60daff68'
    AppId='8a48b5514dd25566014dd6fc92940329'
    SubAccountSid=''
    SubAccountToken=''
    VoIPAccount=''
    VoIPPassword=''
    ...
    def sendTemplateSMS(self, to,datas,tempId):
        ...
        body ='<?xml version="1.0" encoding="utf-8"?><TemplateSMS><datas>'+b+'</datas><to>%s</to><templateId>%s</templateId><appId>%s</appId>\
            ...
            '%(to, tempId,self.AppId)  # SubAccount
        if self.BodyType == 'json':   
...
if __name__=="__main__":
    ...
    r = REST(ServerIP, ServerPort, SoftVersion)
    to = '13161916437'
    data = []
    templateId = '1'
    r.sendTemplateSMS(to, data, templateId)
