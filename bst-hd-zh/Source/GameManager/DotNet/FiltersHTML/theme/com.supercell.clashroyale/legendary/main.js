...
window.setconfig = function (config_json) {
    ...
    if (!config_json.animate) {
        ...
        if ($('#barb_video').length == 0) {
            $('.base-container').append('<video loop id="barb_video" muted preload="auto" style="object-fit:fill;position: absolute; z-index: -1; top: 0px; left: 0px; border: 0px none; padding: 0px;" autoplay="" class="gfyVid" height="100%" width="100%"><source class="mp4source" type="video/webm" src="http://cdn.bluestacks.com/public/btv/resources/filters/legendary.webm"></video>');
