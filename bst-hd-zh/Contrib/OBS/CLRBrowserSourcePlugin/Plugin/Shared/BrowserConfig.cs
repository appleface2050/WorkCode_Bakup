...
namespace CLRBrowserSourcePlugin.Shared
{
    internal class BrowserConfig
    {
        ...
        public bool Save(XElement element)
        {
            ...
            element.SetString("width", BrowserSourceSettings.Width.ToString());
            element.SetString("height", BrowserSourceSettings.Height.ToString());
            element.SetString("url", BrowserSourceSettings.Url.ToString());
