...
public:
    ...
    void Preprocess()
    {
        ...
        if(hDC = GetCurrentHDC())
        {
            ...
            if(captureType == 1)
            {
                int hwndInt = AppConfig->GetInt(L"Video", L"HWND");
                hwndCapture = (HWND)hwndInt;
                ...
                */
                ...
                if(hwndCapture && (IsIconic(hwndCapture) || !IsWindowVisible(hwndCapture)))
                {
                    ...
                    if(!warningID)
                    {
                        ...
                        /*
                         * XXX
                         * This code is hit when the window being streamed cannot be found
                         * because it was minimized or it died
                         */
                    }
                    return;
                }
                ...
                case IDOK:
                    {
						...
						Log(TEXT("in imageSource %d"), sizeX);
