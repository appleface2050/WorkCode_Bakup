...
void VideoCompressor::AudioSample32Bit2Channel(float *Samples, UINT FrameCount, UINT64 CaptureStartTime)
{
    ...
    LONGLONG FileStartCounter = _Clock->_StartTime;
    LONGLONG CaptureStartCounter = CaptureStartTime * _Clock->_TicksPerSecond / LONGLONG(10000000);
    hr = spSample->SetSampleTime( ( CaptureStartCounter - FileStartCounter ) * LONGLONG(10000000) / _Clock->_TicksPerSecond );
